...
const Home = () => {
    ...
    return <div className='w-[90%] mx-auto my-10 md:mt-20 p-10 flex-between max-sm:flex-col-reverse max-sm:text-center'>
        <div className='md:w-[60%] flex flex-col gap-3'>
            ...
            <p className='mt-5 font-semibold max-sm:hidden text-dark-4 text-sm/1'>
            ...
            <p className='mt-5 font-semibold md:hidden text-start text-dark-4 text-sm/1'>
            ...
            <div className='gap-3 mt-4 max-sm:gap-2 flex-items max-sm:flex-col'>
                <button className='flex gap-2 px-3 py-2 text-sm rounded-xl hover:bg-[rgb(112_54_235)] transition-colors bg-dark-2 flex-items'>
        ...
        <div className='relative w-[250px] h-[250px] max-sm:mb-5'>
            <Image
                src={assets.atechpro}
                alt='A_Techpro_C'
                className='object-contain w-[100%] h-[100%] rounded-full border-[4px] border-dark-2 border-dashed shadow-image bg-black'
            />
        </div>
    </div>
}
